  ...
  return (
    <header className="flex items-center justify-between h-11 px-6">
      ...
      <div
        ...
        className="cursor-pointer group p-1 lg:hidden"
        aria-label="Toggle sidebar"
      >
        <MdOutlineMenu className="text-secondary group-hover:text-active text-2xl" />
      </div>
...
<div className="relative flex-1 max-w-md mx-4">
  <div
    className={`relative border border-border bg-primary text-txt shadow-sm
  ...
  >
    ...
    <input
      ...
      className={`w-full pl-10 pr-9 py-1.5 bg-transparent text-txt 
  ...
  {search && (
    <div className="absolute left-0 right-0 bg-primary border border-border border-t-0 rounded-b-lg shadow-sm z-10">
