      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        <div className="lg:w-1/2 space-y-6">
          ...
          <p className="text-txt text-base leading-relaxed max-w-lg">
            I build modern, user-friendly softwares with a focus on performance,
            accessibility, and clean design. With experience in frontend and
            backend development, I enjoy creating products that make a positive
            impact.
          </p>
          <p className="text-txt text-base leading-relaxed max-w-lg">
            ...
            programming, with a strong foundation in web technologies, database
            management, and Angile methodologies. A collaborative team player
